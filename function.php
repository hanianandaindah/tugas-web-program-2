...
function simpan_data_pegawai() {
	...
	if( empty( $nama ) ) {
		$salah[] = '- Pastikan Nama Terisi Dengan Benar...';
	}
	if( empty( $alamat ) ) {
		$salah[] = '- Pastikan Alamat Terisi Dengan Benar...';
	}
	if( empty( $gaji ) ) {
		$salah[] = '- Pastikan Gaji Terisi Dengan Benar...';
	}
	if( empty( $kode ) ) {
		$salah[] = '- Isilah Kode Anda...';
	}
...
function tambah_data_pegawai() {
	...
	echo "		ID Karyawan:<br><input type=\"text\" name=\"kode\" value=\"{$kode}\"><br>\n";
	echo "		Nama Karyawan:<br><input type=\"text\" name=\"nama\" placeholder=\"Isi nama lengkap pegawai...\"><br>\n";
	echo "		Alamat Karyawan:<br><input type=\"text\" name=\"alamat\" placeholder=\"Isi alamat lengkap pegawai...\"><br>\n";
	echo "		Gaji Pokok Karyawan:<br><input type=\"text\" name=\"gaji\" placeholder=\"Isi gaji utama pegawai...\"><br>\n";
...
function ubah_data_pegawai() {
	...
	echo "	<form method=\"post\" action=\"\" autocomplete=\"off\" enctype=\"multipart/form-data\">\n";
	echo "		ID Karyawan:<br><input type=\"text\" name=\"kode\" value=\"{$sql['kode']}\"><br>\n";
	echo "		Nama Karyawan:<br><input type=\"text\" name=\"nama\" placeholder=\"Isi nama lengkap pegawai...\" value=\"{$sql['nama']}\"><br>\n";
	echo "		Alamat Karyawan:<br><input type=\"text\" name=\"alamat\" placeholder=\"Isi alamat lengkap pegawai...\" value=\"{$sql['alamat']}\"><br>\n";
	echo "		Gaji Utama Karyawan:<br><input type=\"text\" name=\"gaji\" placeholder=\"Isi gaji utama pegawai...\" value=\"{$sql['gaji']}\"><br>\n";
	echo "		Jenis Kelamin:<br><select name=\"sex\"><option value=\"0\" selected\">Pilih jenis kelamin</option>\n";
	echo "			<option value=\"Laki-Laki\">Laki-Laki</option><option value=\"Perempuan\">Perempuan</option>\n";
	echo "		</select><br>\n";
	echo "		Status Menikah:<br><select name=\"status\"><option value=\"0\" selected\">Pilih status pernikahan</option>\n";
...
function tampilkan_pegawai() {
	...
	echo "	<td width=\"40\"></td>\n";
	echo "	<td width=\"150\">Nama Karyawan</td>\n";
	echo "	<td width=\"150\">Alamat</td>\n";
	echo "	<td width=\"100\">Gaji Pokok</td>\n";
